!(function (modules) {
  ...
  0: function (module, exports, __webpack_require__) {
    ...
    !(function () {
      function init() {
        (dispatcher.on("wdgt.preferences.setted", onPreference),
          dispatcher.on("wdgt.preferences.getted", onPreference),
          dispatcher.trigger("yandex.mail.get-mailto-value"));
      }
      function onPreference(topic, parameters) {
        parameters.name === preference &&
          ((parameters.value = Boolean(parameters.value)),
      ...
      function onClick(e) {
        for (var node = e.target; node; ) {
          ...
          if (b) {
            var href = node.href;
            "mailto:" === href.substr(0, 7).toLowerCase() &&
              (e.preventDefault(),
              dispatcher.trigger("yandex.mail.compose", {
                url: href,
              }));
            break;
          }
      ...
      var enabled = !1,
        preference = "application.mail-protocol-hook";
      setTimeout(init, 0);
    })();
  },
  262: function (module, exports) {
    ...
    ((Dispatcher.prototype.init = function () {
      ...
      (Dispatcher.prototype.trigger = function (
        ...
        responseCallback
          ? chrome.runtime.sendMessage(params, responseCallback)
      ...
      (Dispatcher.prototype._messageHandler = function (
        params,
        sender,
        sendResponse,
      ) {
        if (params.topic)
          return (
            ...
            (params.options.sendResponse = sendResponse),
            this._internalTrigger(params.topic, params.data, params.options),
            Boolean(params.options.asyncResponse)
          );
      }),
