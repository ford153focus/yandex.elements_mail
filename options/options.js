!(function (modules) {
  ...
  0: function (module, exports, __webpack_require__) {
    ...
    function render() {
      ...
      ((options.title =
        i18n.message("options.label") + ": " + i18n.message("extension.title")),
    ...
    var initer = __webpack_require__(68),
      dispatcher = __webpack_require__(242),
      buildInfo = __webpack_require__(230),
      i18n = __webpack_require__(93),
      config = __webpack_require__(263),
      optionsPage = __webpack_require__(264),
  ...
  6: function (module, exports, __webpack_require__) {
    (function (global) {
      ...
      var utils = __webpack_require__(7),
        innerDispatcher = __webpack_require__(9),
        AppEvent = __webpack_require__(10),
        globalScope = "undefined" == typeof window ? global : window,
        defaultPostfix = ":default",
        nanoId = "_chrome-nano_",
      ...
      ((Preferences.prototype = {
        get: function (name, defaults) {
          ...
          return (
            "undefined" == typeof value &&
              (value = this.restore(name + defaultPostfix)),
        ...
        set: function (name, value) {
          ...
          (this._triggerEvent(AppEvent.PREFERENCE_SET, data),
            this.restore(name) !== JSON.stringify(value) &&
        ...
        store: function (name, value) {
          return (
            "undefined" != typeof value
              ? globalScope.localStorage.setItem(name, value)
              : globalScope.localStorage.removeItem(name),
            value
          );
        },
        restore: function (name) {
          if (name in globalScope.localStorage)
            return globalScope.localStorage.getItem(name);
        },
        defaults: function (defaults) {
          ...
          ("string" == typeof defaults
            ...
            Object.keys(data).forEach(
              function (name) {
                this.restore(name + defaultPostfix) ||
                  this.set(name + defaultPostfix, data[name]);
              }.bind(this),
            ));
        },
        dump: function (data) {
        ...
        migrate: function (name, transform, condition) {
          ...
          (condition &&
            ...
            ((value = transform.call(this, value)), this.set(name, value));
        },
        ...
        _restore: function (key) {
          ...
          if (clearKey) {
            var oldValue = this.get(clearKey),
        ...
        _getClearKey: function (key) {
          ...
          return position >= 0 &&
            position === key.length - defaultPostfix.length
            ? key.substr(0, position)
            : null;
        },
  ...
  7: function (module, exports, __webpack_require__) {
    ...
    module.exports = {
        ...
        return (
          Array.prototype.slice.call(arguments, 1).forEach(function (data) {
            Is.isObject(data) &&
              Object.keys(data).forEach(function (key) {
                var value = data[key];
                value && self.isObject(value)
                  ? ((object[key] && self.isObject(object[key])) ||
                      (object[key] = {}),
                    self.objectUpdate(object[key], value))
                  : (object[key] = value);
              });
          }),
          object
      ...
      flatObject: function (object, delimiter, parent) {
        ...
        return this.isObject(object)
          ? (Object.keys(object).forEach(function (key) {
              ...
              if (self.isString(object[key]) || self.isNumber(object[key]))
                flat[compositeKey] = object[key];
              else {
                var path = compositeKey + delimiter;
                flat = self.objectMerge(
                  flat,
                  self.flatObject(object[key], delimiter, path),
                );
              }
            }),
            flat)
      ...
      getUI: function () {
        for (
          var ui = "{xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx}",
            mask = "0123456789ABCDEF";
          ui.indexOf("x") !== -1;
        )
          ui = ui.replace("x", mask[Math.floor(16 * Math.random())]);
        return ui;
      },
      ...
      dataUriToBlob: function (uri) {
        ...
        (dataString && (buffer = new ArrayBuffer(dataString.length)),
          buffer && (uIntArray = new Uint8Array(buffer)));
        for (var i = 0, max = dataString.length; i < max; i++)
      ...
      path: function (obj, path, delimiter) {
        delimiter = delimiter || ".";
        for (
          var parts = path.split(delimiter), node = obj, i = 0;
          i < parts.length;
          i++
        )
          if (((node = node[parts[i]]), void 0 === node)) return;
        return node;
      },
      isEqualArrays: function (a, b) {
        return (
          !(!this.isArray(a) || !this.isArray(b)) &&
          a.length === b.length &&
          ((a = a.sort()),
          (b = b.sort()),
      ...
      dateToString: function (date) {
        return [
          this.leadingZeros(date.getDate()),
          this.leadingZeros(date.getMonth() + 1),
          date.getFullYear(),
        ].join(".");
      },
      ...
      clearObj: function (obj, values) {
        return (
          this.isArray(values) || (values = []),
          Object.keys(obj).forEach(function (key) {
            ("undefined" == typeof obj[key] ||
              null === obj[key] ||
              values.indexOf(obj[key]) >= 0) &&
              delete obj[key];
          }),
          obj
        );
      ...
      getMajMinVersion: function (version, separator) {
        return (
          (separator = separator || "."),
          version.split(separator).slice(0, 2).join(separator)
        );
      },
    };
  },
  8: function (module, exports) {
    ...
    module.exports = {
      ...
      isObject: function (param) {
        return (
          "object" == typeof param && Boolean(param) && !this.isArray(param)
        );
      },
  ...
  9: function (module, exports) {
    ...
    module.exports = {
      ...
      trigger: function (type, data) {
        var triggers = [];
        this.events[type] &&
          ((this.events[type] = this.events[type].filter(function (event) {
      ...
      hasListener: function (type, handler) {
        return (
          !!this.events[type] &&
          this.events[type].some(function (event) {
            return event.type === type && event.handler === handler;
          })
        );
      },
  ...
  12: function (module, exports, __webpack_require__) {
    "use strict";
    var innerDispatcher = __webpack_require__(9),
      AppEvent = __webpack_require__(10),
      browser = {
        newTabUrls: [
        ...
        run: function () {
          (window.addEventListener("online", this._onLineHandler.bind(this)),
            window.addEventListener(
              "offline",
              this._offlineHandler.bind(this),
            ));
        },
        isChrome: function () {
            ...
            ? void chrome.cookies.getAll(
                ...
                function () {
                  chrome.runtime.lastError
                    ? setTimeout(
                        this.whenBrowserContextAvailable.bind(this, callback),
                        this.BROWSER_OPEN_CHECK_TIME,
                      )
                    : callback();
                }.bind(this),
              )
            : setTimeout(callback, this.BROWSER_OPEN_CHECK_TIME);
        },
        ...
        navigateToSettings: function () {
          var url =
            "chrome-extension://" + chrome.runtime.id + "/options/options.html";
          this.navigate(url);
        },
        openSettings: function () {
          this.navigate(
            chrome.extension.getURL("/options/options.html"),
            "new tab",
          );
        },
        ...
        _isChrome: function () {
          ...
          return (
            ...
            !/MRCHROME|Comodo/.test(userAgent)
          );
        },
  ...
  30: function (module, exports, __webpack_require__) {
    ...
    var get = __webpack_require__(31),
      brandingData = __webpack_require__(43);
    module.exports = {
  ...
  31: function (module, exports, __webpack_require__) {
    function get(object, path, defaultValue) {
      var result =
        null == object ? void 0 : baseGet(object, toPath(path), path + "");
  ...
  53: function (module, exports, __webpack_require__) {
    "use strict";
    var Is = __webpack_require__(8),
      Series = function (tasks, completeHandler, ctx) {
        ((this.completeHandler = completeHandler),
          ...
          (this.done = 0),
          (this.result = null),
          (this.indexedTasks = null));
      };
    ((Series.prototype = {
      run: function () {
        (Is.isObject(this.tasks) &&
          ((this.total = Object.keys(this.tasks).length),
          this._proceedObjectTasks()),
          Is.isArray(this.tasks) &&
            ((this.total = this.tasks.length), this._proceedArrayTasks()),
          Is.isArray(this.tasks) ||
            Is.isObject(this.tasks) ||
            this._onComplete());
      },
      ...
      _proceedArrayTasks: function () {
        ((this.indexedTasks = this.tasks.map(function (task, index) {
          ...
          (this.result = new Array(this.tasks.length)),
          this._nextTask());
      },
      ...
      _onLocalComplete: function () {
        ((this.done += 1),
          this.done >= this.total ? this._onComplete() : this._nextTask());
      },
      _onComplete: function () {
        Is.isFunction(this.completeHandler) &&
          this.completeHandler.call(this.ctx, this.result);
      },
    }),
  ...
  64: function (module, exports, __webpack_require__) {
    "use strict";
    var parallel = __webpack_require__(65),
      series = __webpack_require__(53),
      waterfall = __webpack_require__(66),
      each = __webpack_require__(67);
    module.exports = {
      parallel: parallel,
      series: series,
      waterfall: waterfall,
  ...
  65: function (module, exports, __webpack_require__) {
    "use strict";
    var Is = __webpack_require__(8),
      Parallel = function (tasks, completeHandler, ctx) {
        ((this.completeHandler = completeHandler),
          (this.ctx = ctx || null),
          (this.keys = []),
          (this.tasks = tasks),
    ...
    ((Parallel.prototype = {
      run: function () {
        (Is.isObject(this.tasks) &&
          ((this.total = Object.keys(this.tasks).length),
          this._processObjectTasks()),
          Is.isArray(this.tasks) &&
            ((this.total = this.tasks.length), this._proceedArrayTasks()),
          Is.isArray(this.tasks) ||
            Is.isObject(this.tasks) ||
            this._onComplete(),
          Is.isEmpty(this.tasks) && this._onComplete());
      },
      _processObjectTasks: function () {
        var self = this;
        ((this.result = {}),
          Object.keys(this.tasks).forEach(function (key) {
            Is.isFunction(this.tasks[key]) &&
              this.tasks[key].call(this.ctx, function (localResult) {
      ...
      _proceedArrayTasks: function () {
        ...
        ((this.result = new Array(this.tasks.length)),
          this.tasks.forEach(function (task, index) {
            Is.isFunction(task) &&
              task.call(this.ctx, function (localResult) {
  ...
  66: function (module, exports, __webpack_require__) {
    "use strict";
    var Is = __webpack_require__(8),
      Waterfall = function (tasks, completeHandler, ctx) {
        ((this.completeHandler = completeHandler),
          (this.ctx = ctx || null),
          (this.keys = []),
          (this.tasks = tasks),
    ...
    ((Waterfall.prototype = {
      ...
      _proceedTask: function (task, callback) {
        Is.isFunction(task)
          ? task.apply(this.ctx, this._processArgs(this.result, callback))
          : callback();
      },
      _getTaskIndex: function () {
        return this.indexedTasks[this.done];
      ...
      _onComplete: function () {
        Is.isFunction(this.completeHandler) &&
          this.completeHandler.apply(this.ctx, [].slice.call(this.result));
      },
  ...
  67: function (module, exports, __webpack_require__) {
    "use strict";
    var Is = __webpack_require__(8),
      Each = function (items, iterator, callback) {
        ((this.items = items),
    ...
    ((Each.prototype = {
      run: function () {
        return !Is.isArray(this.items) || this.items.length < 1
          ? this._completeHandler()
          : void this._callNextTask();
      },
    ...
    ((Initer.prototype.add = function (modules) {
      ...
      (Initer.prototype.init = function () {
        return this.modules.length > 0
          ? async.each(
              this.modules,
              this._initModule.bind(this),
              this._onInitComplete.bind(this),
            )
          : void this._onInitComplete();
      }),
  ...
  93: function (module, exports, __webpack_require__) {
    "use strict";
    var pluralRules = __webpack_require__(94),
    ...
    module.exports = {
      ...
      pluralize: function (amount, forms) {
        var idx;
        if (0 === amount && forms.length > 3) idx = 3;
        else {
      ...
      pluralMessage: function (key, placeholder) {
        ...
        if (!Array.isArray(forms))
          throw new Error("Key " + key + " should have plural forms!");
        ...
        [
          ...
          function (amount) {
            ...
            return (variant =
              1 === mode10 && 11 !== mode100
                ? 0
                : mode10 >= 2 && mode10 <= 4 && !(mode100 > 10 && mode100 < 20)
                  ? 1
                  : 2);
          },
        ],
    ...
    module.exports = {
      ...
      get: function (locale) {
        if (!this._rulesForLocale[locale]) {
          ...
          for (var i = 0; i < pluralConfig.length; ++i)
            if (pluralConfig[i][0].indexOf(locale) >= 0) {
  ...
  95: function (module, exports) {
    module.exports = {
      ...
      "forbidden-in-yabrowser":
        "Установка невозможна. Браузер Yandex уже содержит это расширение.",
      geolocation: {
      ...
      infobar: {
        ...
        fb: {
          label:
            "Хотите получать уведомления о новых сообщениях от друзей из [0] Facebook?",
        },
        ok: {
          label:
            "Хотите получать уведомления о новых сообщениях от друзей из [0] Одноклассников?",
        },
        "options-text":
          "Показывать контекстные предложения кнопок Элементов Яндекса",
        video: {
          install: "Установить Яндекс.Браузер",
          label:
            "Режим Турбо ускорит загрузку роликов на [0] при медленном интернете",
        },
        vk: {
          label:
            "Хотите получать уведомления о новых сообщениях от друзей из [0] Вконтакте?",
        },
      },
      legal: {
        dateFormat: "%d.%m.%Y",
      ...
      options: {
        ...
        "mail-show-all-counter":
          "Показывать сумму входящих писем для всех авторизованных пользователей",
      },
      soft: {
      ...
      bar: {
        ...
        warning:
          "Осторожно! Сайт может быть связан с мошенничеством. Вы хотите перейти на настоящий [0]?",
      ...
      malware: {
        body: {
          ext: {
            label:
              "Страница сайта [0] пытается загрузить данные с заражённого сайта [1]. По нашим данным, на [1] был размещён вредоносный программный код. Это могло произойти как по желанию владельцев сайта, так и без их ведома — в результате действий злоумышленников.",
          },
          label:
        ...
        info: {
          label:
            "Более подробную информацию об угрозе или безопасную копию сайта можно посмотреть на [0]странице с полными данными о заражении[1].",
        },
      },
      "month-format": "[0] [1]",
      month: {
      ...
      notify: {
        "cumulative-event": [
          "У Вас [0] новое письмо",
          "У Вас [0] новых письма",
          "У Вас [0] новых писем",
      ...
      yabrowser: {
        description:
          "Кнопка на панели браузера уведомит вас о новых письмах в Яндекс.Почте",
  ...
  96: function (module, exports) {
    module.exports = {
      ...
      "forbidden-in-incognito":
        "The extension does not support incognito mode.",
      "forbidden-in-yabrowser":
      ...
      infobar: {
        ...
        fb: {
          label:
            "Do you want to receive notifications about new messages from your friends on [0] Facebook?",
        },
        ok: {
          label:
            "Do you want to receive notifications about new messages from your friends on [0] Odnoklassniki?",
        },
        "options-text": "Show contextual ads on Yandex.Elements buttons",
        video: {
          install: "Install Yandex.Browser",
          label:
            "Turbo mode speeds up video downloads on [0] when the internet is slow",
        },
        vk: {
          label:
            "Do you want to receive notifications about new messages from your friends on [0] VK?",
        },
      },
      legal: {
        dateFormat: "%d.%m.%Y",
      ...
      options: {
        ...
        opinions: {
          label:
            "Help us improve Yandex services by sharing anonymous browser usage data",
        },
        restore: {
        ...
        "mail-show-all-counter":
          "Show the total number of inbox messages for all signed-in users",
      },
      soft: {
      ...
      bar: {
        ...
        warning:
          "Warning! This site may be fraudulent. Do you want to go to the real [0]?",
      ...
      extension: {
        description:
          "Get new message notifications and quick access to Yandex.Mail.",
      ...
      malware: {
        body: {
          ext: {
            label:
              "A webpage on [0] is attempting to download information from [1], which contains malware. The owner of the site may be completely unaware of any malware installed on the site by hackers.",
          },
          label:
            "We have detected malware on the pages of this site. The owner of the site may be completely unaware of any malware installed on the site by hackers.",
        },
        button: {
          back: {
        ...
        info: {
          label:
            "You can see more detailed information about the threat or a secure cached version of the site on the [0]threat information page[1].",
        },
      },
      "month-format": "[0] [1]",
      month: {
      ...
      yabrowser: {
        description:
          "This button in the browser panel notifies you about new messages in Yandex.Mail",
  ...
  97: function (module, exports) {
    module.exports = {
      ...
      "forbidden-in-yabrowser":
        "Kurulum yapılamaz. Yandex.Browser zaten bu eklentiye sahip.",
      geolocation: {
      ...
      infobar: {
        ...
        fb: {
          label:
            "[0] Facebook'taki arkadaşlarınızdan yeni mesajlar ile ilgili bildirimleri almak istiyor musunuz?",
        },
        ok: {
          label:
            "[0] Odnoklasniki'deki arkadaşlarınızdan yeni mesajlar ile ilgili bildirimleri almak istiyor musunuz?",
        },
        "options-text": "Yandex Elements'in içerik butonu önerilerini göster",
        video: {
          install: "Yandex.Browser'ı kur",
          label:
            "İnternet bağlantısı yavaş olduğunda Turbo modu [0] sitesinde videoların yüklenmesini hızlandırır",
        },
        vk: {
          label:
            "[0] VK'deki arkadaşlarınızdan yeni mesajlar ile ilgili bildirimleri almak istiyor musunuz?",
        },
      },
      legal: {
        dateFormat: "%d.%m.%Y",
      ...
      options: {
        ...
        opinions: {
          label:
            "Yandex servislerinin iyileştirilmesi için tarayıcının kullanım istatistiklerini otomatik ve anonim olarak paylaş",
        },
        restore: {
        ...
        "mail-show-all-counter":
          "Kullanıcı girişi yapan tüm kullanıcıların gelen e-postalarının toplam sayısını göster",
      },
      soft: {
      ...
      bar: {
        ...
        warning:
          "Dikkat! Site sahte olabilir. Buraya mı geçiş yapmak istiyorsunuz: [0]?",
      ...
      extension: {
        description:
          "Yeni e-postalarla ilgili bildirimler ve Yandex.Mail’e hızlı erişim.",
      ...
      malware: {
        body: {
          ext: {
            label:
              "[0] sitesinin sayfası, virüslü [1] sitesinden veri yüklemeye çalışıyor. Elimizdeki verilere göre, [1] sitesinin sayfalarına kötü amaçlı program kodu yerleştirilmiş. Bunu sitenin sahibi bilerek yapmış olabileceği gibi, sahibinin haberi olmadan kötü niyetli kişiler de yapmış olabilir.",
          },
          label:
            "Elimizdeki verilere göre, sitenin sayfalarına kötü amaçlı program kodu yerleştirilmiş. Bunu sitenin sahibi bilerek yapmış olabileceği gibi, sahibinin haberi olmadan kötü niyetli kişiler de yapmış olabilir.",
        },
        button: {
          back: {
            label: "Sayfadan çık",
        ...
        info: {
          label:
            "[0]Burada, risk hakkında daha ayrıntılı bilgi[1] ya da sitenin güvenli kopyasını bulabilirsiniz.",
        },
      },
      "month-format": "[0] [1]",
      month: {
      ...
      yabrowser: {
        description:
          "Tarayıcının panelinde bulunan buton Yandex.Mail'e gelen yeni e-postaları size bildirir",
  ...
  98: function (module, exports) {
    module.exports = {
      ...
      "forbidden-in-yabrowser":
        "Встановлення неможливе. Браузер Yandex уже містить це розширення.",
      geolocation: {
        "options-text":
          "Враховувати моє місце розташування на сервісах Яндекса",
      },
      infobar: {
        agree: "Так",
        close: "Закрити",
        fb: {
          label:
            "Хочете отримувати сповіщення про нові повідомлення від друзів із [0] Facebook?",
        },
        ok: {
          label:
            "Хочете отримувати сповіщення про нові повідомлення від друзів з [0] Однокласників?",
        },
        "options-text":
          "Показувати контекстні пропозиції кнопок Елементів Яндекса",
        video: {
          install: "Встановити Яндекс.Браузер",
          label:
            "Режим Турбо прискорить завантаження роликів на [0] у разі повільного інтернету",
        },
        vk: {
          label:
            "Хочете отримувати сповіщення про нові повідомлення від друзів із [0] Вконтакті?",
        },
      },
      legal: {
        dateFormat: "%d.%m.%Y",
      ...
      options: {
        ...
        opinions: {
          label:
            "Взяти участь у покращенні сервісів Яндекса: автоматично надсилати анонімну статистику використання браузера",
        },
        restore: {
        ...
        "mail-show-all-counter":
          "Показувати суму вхідних листів для усіх авторизованих користувачів",
      },
      soft: {
        label: "Інші програми",
      },
      ...
      bar: {
        ...
        warning:
          "Обережно! Сайт може бути пов'язаний із шахрайством. Ви хочете перейти на справжній [0]?",
      ...
      extension: {
        description:
          "Сповіщення про нові листи і швидкий доступ до Яндекс.Пошти.",
      ...
      malware: {
        body: {
          ext: {
            label:
              "Сторінка сайту [0] намагається завантажити дані із зараженого сайту [1]. За нашими даними, на [1] було розміщено шкідливий програмний код. Це могло статися як за бажанням власників сайту, так і без їхнього відома — в результаті дій зловмисників.",
          },
          label:
            "За нашими даними, на сторінках сайту було розміщено шкідливий програмний код. Це могло статися як за бажанням власників сайту, так і без їхнього відома — в результаті дій зловмисників.",
        },
        button: {
          back: {
        ...
        info: {
          label:
            "Докладнішу інформацію про загрозу або безпечну копію сайту можна подивитися на [0]сторінці з повними даними про зараження[1].",
        },
      },
      "month-format": "[0] [1]",
      month: {
      ...
      notify: {
        "cumulative-event": [
          "У Вас [0] новий лист",
          "У Вас [0] нові листи",
          "У Вас [0] нових листів",
          "У Вас немає нових листів",
        ],
      },
      ...
      yabrowser: {
        description:
          "Кнопка на панелі браузера сповістить вас про нові листи в Яндекс.Пошті",
    ...
    module.exports = {
      ...
      init: function (callback) {
        (chrome.runtime.onMessage.addListener(
          this._chromeMessageHandler.bind(this),
        ),
      ...
      hasListener: function (topic, handler) {
        return (
          !!this.events[topic] &&
          this.events[topic].some(function (event) {
            return event.topic === topic && event.handler === handler;
          })
        );
      },
      ...
      _chromeMessageHandler: function (message, sender, sendResponse) {
        if (message && message.topic && message.transmitter !== this.moduleId) {
          ...
          return (
            (options.tab = sender ? sender.tab : null),
            (options.sendResponse = sendResponse),
            this._internalTrigger(topic, data, options),
  ...
  255: function (module, exports, __webpack_require__) {
    ...
    ((exports.merge = function merge(a, b) {
      ...
      (exports.cls = function (classes, escaped) {
        for (var buf = [], i = 0; i < classes.length; i++)
          escaped && escaped[i]
      ...
      (exports.attr = function (key, val, escaped, terse) {
        return (
          "style" === key && (val = exports.style(val)),
          "boolean" == typeof val || null == val
            ? val
              ? " " + (terse ? key : key + '="' + key + '"')
              : ""
            : 0 == key.indexOf("data") && "string" != typeof val
              ? (JSON.stringify(val).indexOf("&") !== -1,
                val && "function" == typeof val.toISOString,
                " " +
                  key +
                  "='" +
        ...
        if (keys.length)
          for (var i = 0; i < keys.length; ++i) {
            ...
            "class" == key
              ? (val = joinClasses(val)) &&
                buf.push(" " + key + '="' + val + '"')
              : buf.push(exports.attr(key, val, !1, terse));
          }
        return buf.join("");
      }));
  ...
  263: function (module, exports, __webpack_require__) {
    ...
    function getVersion() {
      return (
        ...
        buildInfo.get("build") +
        " (" +
        buildInfo.get("sha").replace("\n", "") +
        ")"
      );
    }
    var i18n = __webpack_require__(93),
      branding = __webpack_require__(30),
      buildInfo = __webpack_require__(230),
      preferences = __webpack_require__(6),
  ...
  264: function (module, exports, __webpack_require__) {
    "use strict";
    var buildInfo = __webpack_require__(230),
      browser = __webpack_require__(12),
      OptionsStats = __webpack_require__(265),
      optionUtils = __webpack_require__(266),
      optionsModel = __webpack_require__(267);
    module.exports = {
      REFRESH_HASH: "#refresh",
      render: function (html, title) {
        (this._renderTemplate(html, title),
          this.firstShow &&
      ...
      _renderTemplate: function (html, title) {
        return document.body
          ? this._render(html, title)
          : void document.addEventListener(
              "DOMContentLoaded",
              this._render.bind(this, html, title),
            );
      },
      ...
      _listenUserActions: function () {
        (this._listenRestoreEvent(),
          this._listenLogEvent(),
          this._listenClick(),
          this._listenChangeEvent());
      },
      _listenRestoreEvent: function () {
        var restoreLink = document.getElementById("restore");
        restoreLink &&
          restoreLink.addEventListener(
            "click",
            this._restoreClickHandler.bind(this),
          );
      },
      _restoreClickHandler: function (event) {
        (event.preventDefault(),
          event.stopImmediatePropagation(),
          this._restoreSharedData(),
          this._reloadPage());
      },
      ...
      _getSharedSettings: function () {
        var sharedInputs = document.querySelectorAll("[data-shared='true']"),
          sharedOptions = [];
        return (
          Array.prototype.forEach.call(sharedInputs, function (input) {
      ...
      _listenLogEvent: function () {
        ...
        logLink &&
          logLink.addEventListener("click", this._logHandler.bind(this));
      },
      _logHandler: function (event) {
        (event.preventDefault(),
          event.stopImmediatePropagation(),
          optionsModel.showLog());
      },
      ...
      _clickHandler: function (event) {
        (event.stopImmediatePropagation(),
          "a" === event.target.tagName.toLowerCase() &&
            (event.preventDefault(), browser.navigate(event.target.href)));
      },
      _listenChangeEvent: function () {
        document.addEventListener("change", this._changeHandler.bind(this));
      },
      _changeHandler: function (event) {
        var preference = event.target.getAttribute("preference"),
          isShared = Boolean(
            event.target.dataset && event.target.dataset.shared,
          ),
          value = optionUtils.getInputValue(event.target),
          preset = event.target.getAttribute("preset");
        (preference && optionsModel.changeOptions(preference, value),
          preference &&
            isShared &&
            optionsModel.changeSharedOptions(preference, value),
    ...
    module.exports = {
      getInputValue: function (input) {
        var type = input.getAttribute("type"),
          value = input.value;
        return (
          "checkbox" === type && (value = Boolean(input.checked)),
          "number" === type &&
            ((value = this.getNumberInputValue(input)), (input.value = value)),
          value
        );
      },
  ...
  267: function (module, exports, __webpack_require__) {
    ...
    var dispatcher = __webpack_require__(242),
      OptionEvent = __webpack_require__(251);
    module.exports = {
      ...
      changeSharedOptions: function (key, value) {
        var data = {};
        ((data[key] = value),
          dispatcher.trigger(OptionEvent.UPDATE_SHARED_DATA, data));
      },
        ...
        function (
          ...
          (buf.push(
            '<div class="header">' +
              ...
              '</div><hr/><div class="group checkbox"><label>',
          ),
            (option = "application.mail-protocol-hook"),
            buf.push(
              '<input type="checkbox"' +
                jade.attr("checked", pref.get(option), !0, !1) +
                jade.attr("preference", option, !0, !1) +
                '/><div class="title">' +
                jade.escape(
                  null == (jade_interp = i18n("options.mail-protocol-hook"))
                    ? ""
                    : jade_interp,
                ) +
                "</div></label></div>",
            ...
            yabrowser ||
              (buf.push('<div class="group checkbox"><label>'),
              (option = "showTextAlert"),
              buf.push(
                '<input type="checkbox"' +
                  jade.attr("checked", pref.get(option), !0, !1) +
                  jade.attr("preference", option, !0, !1) +
                  '/><div class="title">' +
                  jade.escape(
                    null == (jade_interp = i18n("options.mail-push-enable"))
                      ? ""
                      : jade_interp,
                  ) +
                  '</div></label></div><div class="group checkbox"><label>',
              ),
              (option = "playSoundAlert"),
              buf.push(
                '<input type="checkbox"' +
                  jade.attr("checked", pref.get(option), !0, !1) +
                  jade.attr("preference", option, !0, !1) +
                  ' preset="mailsound"/><div class="title">' +
                  jade.escape(
                    null == (jade_interp = i18n("mail.alert.sound.label"))
                      ? ""
                      : jade_interp,
                  ) +
                  "</div></label></div>",
            ...
            buf.push('<div class="group checkbox"><label>'),
            (option = "allAccountsCounter"),
            buf.push(
              '<input type="checkbox"' +
                jade.attr("checked", pref.get(option), !0, !1) +
                jade.attr("preference", option, !0, !1) +
                ' preset="sumcount"/><div class="title">' +
                jade.escape(
                  null == (jade_interp = i18n("options.mail-show-all-counter"))
                    ? ""
                    : jade_interp,
                ) +
                '</div></label></div><div class="group checkbox"><label>',
            ),
            (option = "application.open-portal"),
            buf.push(
              '<input type="checkbox"' +
                jade.attr("checked", pref.get(option), !0, !1) +
                jade.attr("preference", option, !0, !1) +
                '/><div class="title">' +
                jade.escape(
                  null == (jade_interp = i18n("mail.openServiceOnClick.label"))
                    ? ""
                    : jade_interp,
                ) +
                "</div></label></div>",
            ...
            contextMenuDisabled ||
              (buf.push('<div class="group checkbox"><label>'),
              (option = "application.context-menu.enabled"),
              buf.push(
                '<input type="checkbox"' +
                  jade.attr("checked", pref.get(option), !0, !1) +
                  jade.attr("preference", option, !0, !1) +
                  ' data-shared="true" preset="context_menu"/><div class="title">' +
                  jade.escape(
                    null == (jade_interp = i18n("context-menu.options-text"))
                      ? ""
                      : jade_interp,
                  ) +
                  "</div></label></div>",
            ...
            opinionsDisabled ||
              (buf.push('<div class="group checkbox"><label>'),
              (option = "application.tab.opinions.enabled"),
              buf.push(
                '<input type="checkbox"' +
                  jade.attr("checked", pref.get(option), !0, !1) +
                  jade.attr("preference", option, !0, !1) +
                  ' data-shared="true" preset="barnavig"/><div class="title">' +
                  jade.escape(
                    null == (jade_interp = i18n("options.opinions.label"))
                      ? ""
                      : jade_interp,
                  ) +
                  "</div></label></div>",
            ...
            gpautoDisabled ||
              (buf.push('<div class="group checkbox"><label>'),
              (option = "application.geolocation.enabled"),
              buf.push(
                '<input type="checkbox"' +
                  jade.attr("checked", pref.get(option), !0, !1) +
                  jade.attr("preference", option, !0, !1) +
                  ' data-shared="true" preset="location"/><div class="title">' +
                  jade.escape(
                    null == (jade_interp = i18n("geolocation.options-text"))
                      ? ""
                      : jade_interp,
                  ) +
                  "</div></label></div>",
              )),
            ("undefined" != typeof restoreDisabled && restoreDisabled !== !1) ||
              buf.push(
                '<div style="margin-top: 30px" class="group"><a id="restore" href="#">' +
                  jade.escape(
                    null == (jade_interp = i18n("options.restore.label"))
                      ? ""
                      : jade_interp,
                  ) +
                  "</a></div>",
            ...
            logsDisabled ||
              buf.push(
                '<div class="group"><a id="log-link" href="">' +
                  jade.escape(
                    null == (jade_interp = i18n("options.logs"))
                      ? ""
                      : jade_interp,
                  ) +
                  "</a></div>",
            ...
            buf.push(
              '<div style="margin-top: 30px" class="group"><a' +
                jade.attr("href", branding("soft.url"), !0, !1) +
                ' target="_blank">' +
                jade.escape(
                  null == (jade_interp = i18n("soft.label")) ? "" : jade_interp,
                ) +
                '</a></div><div class="group"><a' +
                jade.attr("href", branding("support.url"), !0, !1) +
                ' target="_blank">' +
                jade.escape(
                  null == (jade_interp = i18n("support.label"))
                    ? ""
                    : jade_interp,
                ) +
                '</a></div><div class="group"><a' +
                jade.attr("href", branding("license.url"), !0, !1) +
                ' target="_blank">' +
                jade.escape(
                  null == (jade_interp = i18n("license.label"))
                    ? ""
                    : jade_interp,
                ) +
                '</a></div><div style="font-size: 1em" class="group">' +
                jade.escape(null == (jade_interp = name) ? "" : jade_interp) +
                "<br/>" +
                jade.escape(
                  null ==
                    (jade_interp = i18n("legal.version", [
                      version,
                      versionDate,
                    ]))
                    ? ""
                ...
                "<br/>&copy; " +
                jade.escape(
                  null == (jade_interp = firstYear) ? "" : jade_interp,
                ) +
                jade.escape(
                  null ==
                    (jade_interp = lastYear > firstYear ? "-" + lastYear : "")
                    ? ""
                    : jade_interp,
                ) +
                " " +
                jade.escape(
                  null == (jade_interp = i18n("legal.yandex"))
                    ? ""
                    : jade_interp,
                ) +
                "</div>",
          ...
          this,
          "branding" in locals_for_with
            ? locals_for_with.branding
            : "undefined" != typeof branding
              ? branding
              : void 0,
          "contextMenuDisabled" in locals_for_with
            ? locals_for_with.contextMenuDisabled
            : "undefined" != typeof contextMenuDisabled
              ? contextMenuDisabled
              : void 0,
          "firstYear" in locals_for_with
            ? locals_for_with.firstYear
            : "undefined" != typeof firstYear
              ? firstYear
              : void 0,
          "gpautoDisabled" in locals_for_with
            ? locals_for_with.gpautoDisabled
            : "undefined" != typeof gpautoDisabled
              ? gpautoDisabled
              : void 0,
          "i18n" in locals_for_with
            ? locals_for_with.i18n
            : "undefined" != typeof i18n
              ? i18n
              : void 0,
          "lastYear" in locals_for_with
            ? locals_for_with.lastYear
            : "undefined" != typeof lastYear
              ? lastYear
              : void 0,
          "logsDisabled" in locals_for_with
            ? locals_for_with.logsDisabled
            : "undefined" != typeof logsDisabled
              ? logsDisabled
              : void 0,
          "name" in locals_for_with
            ...
            : "undefined" != typeof name
              ? name
              : void 0,
          "opinionsDisabled" in locals_for_with
            ? locals_for_with.opinionsDisabled
            : "undefined" != typeof opinionsDisabled
              ? opinionsDisabled
              : void 0,
          "option" in locals_for_with
            ...
            : "undefined" != typeof option
              ? option
              : void 0,
          "pref" in locals_for_with
            ? locals_for_with.pref
            : "undefined" != typeof pref
              ? pref
              : void 0,
          "restoreDisabled" in locals_for_with
            ? locals_for_with.restoreDisabled
            : "undefined" != typeof restoreDisabled
              ? restoreDisabled
              : void 0,
          "title" in locals_for_with
            ...
            : "undefined" != typeof title
              ? title
              : void 0,
          "version" in locals_for_with
            ? locals_for_with.version
            : "undefined" != typeof version
              ? version
              : void 0,
          "versionDate" in locals_for_with
            ? locals_for_with.versionDate
            : "undefined" != typeof versionDate
              ? versionDate
              : void 0,
          "yabrowser" in locals_for_with
            ? locals_for_with.yabrowser
            : "undefined" != typeof yabrowser
              ? yabrowser
              : void 0,
        ),
        buf.join("")
